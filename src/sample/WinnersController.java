...
public class WinnersController implements Initializable {
    ...
    ObservableList<Winners> ballotObservableList = FXCollections.observableArrayList();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for (String pstn : pstnNames) {
            try {
                ...
                ResultSet resultSet = connection.createStatement().executeQuery("SELECT results.Vote_count, candidate_register.Name, candidate_register.Avatar FROM voter_db.results INNER JOIN voter_db.candidate_register ON results.Candidate_ID = candidate_register.CandidateID");
